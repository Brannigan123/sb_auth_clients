...
class SigninResponse {
  ...
  @override
  String toString() => 'SigninResponse[errored=$errored, messages=$messages, token=$token, refreshToken=$refreshToken, username=$username, displayName=$displayName, email=$email, roles=$roles, emailVerified=$emailVerified, lockedAccount=$lockedAccount, deletedAccount=$deletedAccount]';
