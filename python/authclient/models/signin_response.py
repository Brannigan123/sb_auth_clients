...
class SigninResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SigninResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SigninResponse:
        """Create an instance of SigninResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SigninResponse.parse_obj(obj)

        _obj = SigninResponse.parse_obj({
