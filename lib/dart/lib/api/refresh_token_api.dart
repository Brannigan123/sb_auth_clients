...
class RefreshTokenApi {
  RefreshTokenApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;

  final ApiClient apiClient;

  /// Performs an HTTP 'POST /api/v1/auth/public/refresh-token' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [TokenRefreshRequest] tokenRefreshRequest (required):
  Future<Response> refeshTokenWithHttpInfo(TokenRefreshRequest tokenRefreshRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/api/v1/auth/public/refresh-token';
