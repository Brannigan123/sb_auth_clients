...
class AuthenticateApi:
    ...
    def authenticate(self, signin_request : SigninRequest, async_req: Optional[bool]=None, **kwargs) -> Union[SigninResponse, Awaitable[SigninResponse]]:  # noqa: E501
        ...
        >>> thread = api.authenticate(signin_request, async_req=True)
        >>> result = thread.get()

        :param signin_request: (required)
        :type signin_request: SigninRequest
        ...
        return self.authenticate_with_http_info(signin_request, **kwargs)  # noqa: E501

    @validate_arguments
    def authenticate_with_http_info(self, signin_request : SigninRequest, **kwargs) -> ApiResponse:  # noqa: E501
        """authenticate  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.authenticate_with_http_info(signin_request, async_req=True)
        >>> result = thread.get()
        ...
        _body_params = None
        if _params['signin_request'] is not None:
            _body_params = _params['signin_request']
        ...
        return self.api_client.call_api(
            '/api/v1/auth/public/authenticate', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
