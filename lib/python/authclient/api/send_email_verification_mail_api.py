...
class SendEmailVerificationMailApi:
    ...
    def send_verification_email(self, async_req: Optional[bool]=None, **kwargs) -> Union[OtpRequestResponse, Awaitable[OtpRequestResponse]]:  # noqa: E501
        ...
        >>> thread = api.send_verification_email(async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the send_verification_email_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.send_verification_email_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def send_verification_email_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """send_verification_email  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.send_verification_email_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method send_verification_email" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/v1/auth/authenticated/send-email-verification-mail', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
