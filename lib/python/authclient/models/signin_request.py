...
class SigninRequest(BaseModel):
    ...
    __properties = ["emailOrUsername", "password"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SigninRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SigninRequest:
        """Create an instance of SigninRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SigninRequest.parse_obj(obj)

        _obj = SigninRequest.parse_obj({
