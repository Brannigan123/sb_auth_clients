...
public class SendEmailVerificationMailApi {
     ...
     */
    public ModelApiResponse sendVerificationEmail() throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<ModelApiResponse> sendVerificationEmailWithHttpInfo() throws RestClientException {
